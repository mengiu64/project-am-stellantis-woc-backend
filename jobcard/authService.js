...
// con scope/client_id ormai obsoleti (v. jobCardList 403 "unknown scope"). La chiave
// è namespaced per modulo per evitare collisioni nella tabella condivisa.
const TOKEN_CACHE_KEY = 'jobcard:authtoken';
