...
/**
 * db.js — Connessione al database Aurora PostgreSQL "wiadvisor" (tabelle
 * woc.dml_enabled_markets / woc.dml_configurations).
 *
 ...
 * http://localhost:<port>/secretsmanager/get — stesso meccanismo già usato da
 * pkFavorite/db.js e dbManager/db.js. Host/porta/nome db possono invece arrivare
 * da env var (template.yaml) oppure, se assenti, dal secret stesso (che le
 * contiene già).
 *
