...
/** Lambda handler – GET availableHours  ({ id, ... }) */
exports.handler = async (event) => {
  ...
  try {
    ...
    // Validazione dell'input: parametro obbligatorio mancante -> input non valido.
    if (!params.id) {
  ...
  try {
    ...
    const result = await client.availableHours(params);
