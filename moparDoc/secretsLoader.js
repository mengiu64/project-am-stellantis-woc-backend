 ...
 * @param {string} paramName - Percorso del parametro SSM (es. /app/np-BSN0027990-dev/MOPARDOC)
...
async function loadSecrets() {
  ...
  const ssmParamPath = process.env.MOPARDOC_PARAM_NAME;
  // Verifica che la variabile d'ambiente sia presente
  if (!ssmParamPath) {
    throw new Error('[secrets] Variabile d\'ambiente MOPARDOC_PARAM_NAME non configurata');
  }
