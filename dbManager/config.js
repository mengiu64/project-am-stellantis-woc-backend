...
module.exports = {
  ...
  db: {
    host: process.env.DBMANAGER_DB_HOST,
    ...
    port: process.env.DBMANAGER_DB_PORT ? Number(process.env.DBMANAGER_DB_PORT) : undefined,
    name: process.env.DBMANAGER_DB_NAME,
    user: process.env.DBMANAGER_DB_USER,
    password: process.env.DBMANAGER_DB_PASSWORD,
    // Aurora richiede/accetta TLS; impostare DBMANAGER_DB_SSL=false solo per
    // test locali contro un Postgres senza TLS.
    ssl: process.env.DBMANAGER_DB_SSL !== 'false',
  },
  ...
  // stesso meccanismo già usato da pkFavorite/db.js e myPeople/certService.js.
  secrets: {
    dbSecretId: process.env.DBMANAGER_DB_SECRET_ID || 'sm-np-bsn0027990-dev-aurora-app',
