...
/**
 * db.js — Connessione al database Aurora PostgreSQL "wiadvisor" (tabella HQ_PKCONFIG).
 *
 ...
 * pkFavorite/db.js e myPeople/certService.js. Host/porta/nome db possono invece
 * arrivare da env var (template.yaml) oppure, se assenti, dal secret stesso
 * (che le contiene già).
 *
