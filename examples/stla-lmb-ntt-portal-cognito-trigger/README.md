# stla-lmb-ntt-portal-cognito-trigger

AWS Lambda - NTT Portal: Cognito pre-token generation trigger for enriching ID/access tokens with custom claims

- DEV Lambda: `lmb-np-BSN0027990-dev-ntt-portal-cognito-trigger`
- DEV Role: `stla-rol-np-BSN0027990-dev-ntt-portal-cognito-trigger`
## Overview
