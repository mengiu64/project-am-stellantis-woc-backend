...
// Client PingFederate condiviso con la lambda jobcard (stesso authService.js):
// entrambe le lambda ottengono il Bearer token dallo stesso endpoint/scope, ciascuna
// con la propria cache su DynamoDB (TmpCacheTable, v. dynamoCache.js).
...
// Cache del Bearer token OAuth2 su DynamoDB (TmpCacheTable, v. dynamoCache.js):
// sostituisce la precedente cache su file /tmp, non condivisa tra le istanze/funzioni
// Lambda e potenzialmente sopravvissuta troppo a lungo in un container "warm",
// servendo token con scope/client_id ormai obsoleti. La chiave è namespaced per
// modulo per evitare collisioni nella tabella condivisa.
const TOKEN_CACHE_KEY = 'djc:authtoken';
