...
#
# Prerequisito: ogni modulo (pkManager, pkEper, pkDocsoa, pkMenupricing, dms, dbManager)
# deve avere già eseguito `npm ci --omit=dev` (vedi step CI "Install npm dependencies")
